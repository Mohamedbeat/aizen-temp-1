    ...
    <div className="">
      ...
      <div className="w-[100%] mt-[50px] sm:mt-[76px] py-3 flex flex-col items-center  ">
        ...
        >
          ...
          {/*  */}
          <div
            className="flex flex-col gap-6 items-center justify-between w-[100%] my-[20px]
                sm:flex sm:flex-row sm:gap-6 sm:items-center sm:justify-between sm:w-[100%] sm:my-0 "
          >
            {/* infos here */}
            {Infos !== null && (
              <div className="flex-1 flex flex-col items-center sm:items-start gap-[10px] sm:gap-[20px]  ">
                <h1 className="text-[25px] sm:text-[30px] "> Contactez-nous</h1>
                <p className="text-center sm:text-left">
                  Nous aimons vous entendre! Si vous avez des questions ou des
                  requêtes, remplissez simplement ce formulaire ou envoyez-nous
                  un e-mail.
                </p>
            ...
            <div className="flex-1 w-[85%] sm:w-full ">
              <form className="flex-1 flex flex-col items-center sm:items-start gap-[10px] sm:gap-[20px]">
                ...
                ></textarea>
                <input
                  className=" bg-zinc-950 text-white w-[100%] py-2 rounded-md
          ...
          >
            {Infos !== null && (
              <iframe
                src={`https://maps.google.com/maps?q=${Infos.info.lating},${Infos.info.lnging}&hl=es;&output=embed`}
                style={{ border: 0 }}
                allowFullScreen=""
