...
export default function LeftShopContent() {
  ...
  const [isFiltersMenuOpen, setFiltersMenuOpen] = useState(true);
  ...
  return (
    <>
      <button
        ...
        className="sm:hidden my-[15px] flex items-center justify-between w-full text-[23px] font-bold border-b "
      >
        <p>Filters</p>
        <p>{isFiltersMenuOpen ? "x" : "+"}</p>
      </button>
      {isFiltersMenuOpen && (
        <div
          className="flex-[1] 
