...
export default function Header() {
    ...
    const handleClick =(action)=>{
        document.getElementById('sideMenu').style.transition='0.4s all ease-in-out'
        if(action === 'open'){
  ...
  return (
    ...
    <div  className='bg-zinc-950 flex items-center justify-center'>
        <div className='w-[100%] text-white flex justify-around   py-2 text-center sm:flex sm:items-center sm:justify-between sm:w-[100%] sm:max-w-[1024px] sm:py-2 sm:text-white sm:font-bold '>
            {Infos!==null && <div >
                {Infos.description.b_title_2}
            </div>}
            {Infos!==null && <div >
                {Infos.description.s_title_2}
            </div>}
        </div>
    </div>
    ...
    {/* WE START FROM HERE */}
    <div id='lower' className=' z-[5] absolute w-[100%] bg-zinc-950 sm:bg-zinc-950 sm:bg-opacity-10 sm:backdrop-blur-md font-medium text-white flex items-center justify-center'>
        <div className='relative w-[100%] flex  items-center justify-around py-3
        sm:w-[100%] sm:max-w-[1024px] sm:flex sm:items-center sm:justify-center sm:py-5'>
                ...
                <div  className=' order-2 flex-1  sm:order-1 sm:flex-[1] text-left '>
                    ...
                    {Infos!== null && <img className='object-cover sm:w-[90%]'
                ...
                viewBox="0 0 24 24" style={{fill:"white"}} className='flex-1 sm:hidden'
                onClick={()=>handleClick('open')} >
                    <path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z"></path></svg>
                    
                <div id='sideMenu' className={`absolute       
                top-[0] 
                left-[-500px]
                h-[100vh] w-[100vw] 
                ...
                sm:static sm:order-2 sm:flex-[3] sm:h-auto sm:w-auto  text-center`} >
                    <ul className='flex relative flex-col rounded-lg p-10
                    ...
                    sm:flex sm:flex-row sm:h-auto sm:w-auto sm:p-0 sm:bg-transparent sm:text-white sm:items-center sm:justify-between sm:gap-5 sm:text-[15px] ' >
                        ...
                        style={{fill:"black"}} className='absolute top-[5px] right-[5px] 
                        ...
                        <li ><Link to={'/home'} className='sm:rounded-full sm:hover:bg-slate-950 sm:px-3 sm:py-1 
                        '>Vitrine</Link></li>
                        <li>
                        <Link className='flex relative items-center justify-center  sm:rounded-full sm:hover:bg-slate-950 sm:px-3 sm:py-1
                        '  
                        onClick={()=>setCategoryState1()} >
                        Catégories
                        <svg className='fill-slate-950 sm:fill-slate-50' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"  >
                        ...
                        <li><Link to={'/shop'} className='sm:rounded-full sm:hover:bg-slate-950 sm:px-3 sm:py-1
                        '>Shop</Link></li>
                        <li><Link to={'/commande'} className='sm:rounded-full sm:hover:bg-slate-950 sm:px-3 sm:py-1
                        '>Mes commandes</Link></li>
                        <li><Link to={'/contact'} className='sm:rounded-full sm:hover:bg-slate-950 sm:px-3 sm:py-1
                        '>Contact</Link></li>
                    </ul>
                </div>
            ...
            <svg onClick={()=>setCartState(!cartState)} className='cursor-pointer' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: "white"}}>
                <path className='text-white' d="M21 4H2v2h2.3l3.28 9a3 3 0 0 0 2.82 2H19v-2h-8.6a1 1 0 0 1-.94-.66L9 13h9.28a2 2 0 0 0 1.92-1.45L22 5.27A1 1 0 0 0 21.27 4 .84.84 0 0 0 21 4zm-2.75 7h-10L6.43 6h13.24z">
                </path>
