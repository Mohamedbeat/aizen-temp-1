  ...
  return (
    <>
      {cartState === true && (
        <div
          id="cart"
          className="absolute text-black bg-white top-[100%] left-[12%] p-3 w-[300px] 
        ...
        >
          {/* items container */}
          <div className="w-full flex flex-col gap-[10px] overflow-auto max-h-[300px] ">
            <div
              className="w-[95%] flex flex-row items-center justify-between
                border-[2px] rounded-lg border-zinc-700 p-2

                sm:w-[95%] sm:flex sm:flex-row sm:items-center sm:justify-between
          ...
          >
            <Link
              className=" bg-zinc-950 text-white text-center py-2 w-[100%]
